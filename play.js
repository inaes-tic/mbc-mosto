...
play.prototype.buildStatus = function( myself, serverPlaylist, serverStatus) {
    ...
    //console.log("mbc-mosto: [INFO] [PLAY] buildStatus: serverplaylist: " + serverPlaylist + " serverstatus:" + serverStatus + " playlists:"+this.fetcher.playlists );
...
play.prototype.statusHasChanged = function( self ) {

    console.log("mbc-mosto: [INFO] [PLAY] checking status.... prev_full_status: " + self.prev_full_status);

    var result = ( self.prev_full_status === undefined );

    console.log("mbc-mosto: [INFO] [PLAY] checking status.... full_status: " + self.full_status);
    ...
    var not = "";
    (result) ? not="" : not="not ";
    console.log("mbc-mosto: [INFO] [PLAY] Status has "+not+"changed.");
    return result;
}
...
play.prototype.timer_fun_status = function( myself, actual_status ) {
    ...
    console.log("mbc-mosto: [INFO] [PLAY] Calling for Server Playlist");
    self.server.getServerPlaylist( function play_get_server_playlist( server_playing_list ) {

            console.log("mbc-mosto: [INFO] [PLAY] building status. From self, self.actual_playing_clip:" + self.actual_playing_clip);
            //console.log(self);
            ...
            if ( self.statusHasChanged( self ) ) {
                //console.log("mbc-mosto: [INFO] [PLAY] status has changed so we emit full status : " + this.full_status);
...
play.prototype.timerUnlock = function(mess) {
    console.log("mbc-mosto: [INFO] [PLAY] Unlocking from " + mess );
    this.sync_lock = false;
}
...
play.prototype.timer_fun = function(myself) {
...
play.prototype.play = function( myself ) {
    var self = myself;
    ...
    if (!self.timer) {
        ...
        //self.timer_funT = self.timer_fun.bind(this);
        //console.log("player:");
        //console.log(self);
        console.log("mbc-mosto: [INFO] [PLAY] Creating Interval Timer each "+  self.mosto.config.timer_interval + " ms.");
        ...
        self.on('status', function(st) {
            console.log("mbc-mosto: [INFO] [PLAY] emitting status: " + st);
